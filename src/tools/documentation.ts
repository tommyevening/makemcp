...
const TOOL_DOCS: Record<string, string> = {
  ...
  make_verify_scenario: "Closed-loop check: reads Make's isinvalid flag + re-validates a deployed scenario so you can autofix.",
  make_run_scenario: "Trigger a manual run of a scenario by id (needs scenarios:run scope).",
